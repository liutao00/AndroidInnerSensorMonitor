...
public class PressureGraph {
    ...
    private TimeSeries xSeries = new TimeSeries("Pressure");
    ...
    public PressureGraph() {
        ...
        mRenderer.setYTitle("Pressure Value");
        mRenderer.setChartTitle("Pressure vs Time");
    ...
    public GraphicalView getPressureView(Context context) {
